...
import { X, Clock, Image, Shuffle } from 'lucide-react';
import { AlarmSettings, Playlist } from '@/data/mockData';
...
export function CreatePlaylistDialog({ onClose, onCreate, onUpdate, editingPlaylist }: CreatePlaylistDialogProps) {
  ...
  const [selectedDays, setSelectedDays] = useState<('sun' | 'mon' | 'tue' | 'wed' | 'thu' | 'fri' | 'sat')[]>(editingPlaylist?.alarm?.days || []);
