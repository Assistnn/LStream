import { Check, ChevronRight, Fingerprint, Lock, Mail, Plus, ShieldCheck, Trash2, X } from 'lucide-react'
...
export function AccountScreen({
  ...
  return (
    <>
        ...
        <div className='flex-1 overflow-y-auto'>
            ...
            <div className='px-4 py-6 border-b border-gray-200 dark:border-gray-800'>
              <div className='flex items-center gap-4'>
                ...
                <div className='flex-1 min-w-0'>
                  {/* User Name */}
                  <h2 className='text-xl font-bold text-gray-900 dark:text-white truncate'>{activeAccount.userName}</h2>
                  {/* Email */}
                  <p className='text-sm text-gray-600 dark:text-gray-400 truncate mt-0.5'>{activeAccount.email}</p>
                  {/* Service Info */}
          ...
          <div className='px-4 py-4'>
            <div className='flex items-center justify-between mb-3'>
              <h3 className='text-base font-semibold text-gray-900 dark:text-white'>サービスアカウント</h3>
              <button
            ...
            {showAddForm && (
              <div className='mb-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg'>
                <h4 className='text-sm font-semibold text-gray-900 dark:text-white mb-3'>新規サービスアカウント</h4>
                    ...
                    >
                      <div className='flex items-center gap-3'>
                        ...
                        <div className='flex-1 min-w-0'>
                          ...
                          {/* Email */}
                          <p className='text-xs text-gray-500 dark:text-gray-400 truncate'>{serviceAccount.email}</p>
          ...
          <div className='px-4 py-4 border-t border-gray-200 dark:border-gray-800'>
            <div className='flex items-center gap-2 mb-3'>
              ...
              <h3 className='text-base font-semibold text-gray-900 dark:text-white'>セキュリティ</h3>
            </div>
            ...
            <div className='space-y-3'>
              ...
              <div className='flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg'>
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    <h4 className='text-sm font-semibold text-gray-900 dark:text-white'>Face ID / Touch ID</h4>
                    <p className='text-xs text-gray-500 dark:text-gray-400'>生体認証でロック解除</p>
                  </div>
                </div>
                <button
              ...
              <div className='flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg'>
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    <h4 className='text-sm font-semibold text-gray-900 dark:text-white'>パスコードロック</h4>
                    <p className='text-xs text-gray-500 dark:text-gray-400'>6桁のパスコードを設定</p>
                  </div>
                </div>
                <button
                  onClick={() => setPasscodeEnabled(!passcodeEnabled)}
                  className={`relative w-12 h-7 rounded-full transition-colors ${
                    passcodeEnabled ? 'bg-blue-600' : 'bg-gray-300 dark:bg-gray-600'
                  }`}
                >
                  <div
                    className={`absolute top-1 left-1 w-5 h-5 rounded-full bg-white transition-transform ${
      ...
      {deleteConfirmId && (
        <>
          <div className='fixed inset-0 bg-black/50 z-[80]' onClick={() => setDeleteConfirmId(null)} />
          <div className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-gray-800 rounded-2xl p-6 z-[90] max-w-sm w-[90%] shadow-2xl'>
            <h3 className='text-lg font-bold text-gray-900 dark:text-white mb-2'>アカウントを削除</h3>
