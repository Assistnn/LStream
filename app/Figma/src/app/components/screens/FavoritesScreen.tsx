...
import { Heart, Play, MoreVertical, Download } from 'lucide-react';
import { Content, Series, Episode, Chapter, isContent, isSeries, formatDuration, getCategoryLabel } from '@/data/mockData';
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0 cursor-pointer">
                        ...
                        <div className="h-5 flex items-center gap-2 text-[10px] font-semibold">
                          ...
                          {item.playCount > 0 && (
                            <span className="text-purple-700 dark:text-purple-400">{item.playCount.toLocaleString()}回再生</span>
                          )}
                      ...
                      <div className="flex flex-col gap-1 items-center flex-shrink-0 relative">
                        ...
                        {showMenu === item.id && (
                          <div ref={menuRef} className="absolute top-full right-0 mt-1 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1 min-w-[160px] z-10">
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-700 border-t border-gray-200 dark:border-gray-700">{
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 cursor-pointer">
                    ...
                    <div className="h-5 flex items-center gap-2 text-[10px] font-semibold">
                      ...
                      {episode.playCount > 0 && (
                        <span className="text-purple-700 dark:text-purple-400">{episode.playCount.toLocaleString()}回再生</span>
                      )}
                      <span className="text-gray-500 dark:text-gray-400">
              ...
              {favoriteChapters.map(({ chapter, episode, series }) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 cursor-pointer">
                    <h4 className="font-semibold text-gray-900 dark:text-white truncate mb-1">
                      <span className="text-xs text-gray-600 dark:text-gray-300 mr-1.5">Ep.{episode.episodeNumber} Unit.{chapter.chapterNumber}</span>
                      {chapter.title}
                    </h4>
                    <p className="text-xs text-gray-500 dark:text-gray-400 truncate mb-0.5">
                      {series.title}
