import { ChevronLeft, Heart, Play, Plus } from 'lucide-react'
...
export function ContentDetailScreen({ content, onBack, onPlay, onToggleFavorite }: ContentDetailScreenProps) {
          ...
          >
            <Heart
              className={`w-6 h-6 text-gray-700 dark:text-gray-300 ${
                content.isFavorite ? 'fill-gray-700 dark:fill-gray-300' : ''
              }`}
            />
          </button>
        </div>
