import { Clock, Download, Edit, List, Pin, Play, Plus, Trash2 } from 'lucide-react'
      ...
      <div className='mb-6 border-t border-b border-gray-200 dark:border-gray-700'>
        ...
        >
          ...
          <div className='flex-1 text-left'>
            <h3 className='font-semibold text-gray-900 dark:text-white mb-1'>再生キュー</h3>
            <p className='text-sm text-gray-500 dark:text-gray-400'>{queueCount}メディア</p>
          </div>
        </button>
      </div>
      ...
      <div>
        ...
        {playlists.length > 0 ? (
          ...
          <div className='text-center py-16'>
            ...
            <h3 className='text-lg font-semibold text-gray-900 dark:text-white mb-2'>プレイリストがありません</h3>
            <p className='text-sm text-gray-500 dark:text-gray-400 mb-6'>新規作成からプレイリストを作成してください</p>
          </div>
        )}
      </div>
    </div>
