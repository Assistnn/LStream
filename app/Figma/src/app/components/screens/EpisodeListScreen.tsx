  ...
  useEffect(() => {
    function handleClickOutside(event: MouseEvent) {
      ...
      if (
        ...
        !seriesMenuRef.current.contains(event.target as Node) &&
        seriesMenuButtonRef.current &&
        !seriesMenuButtonRef.current.contains(event.target as Node)
      ) {
  ...
  return (
    <div className='fixed top-0 left-0 right-0 bottom-20 bg-gray-50 dark:bg-gray-900 z-40 overflow-y-auto'>
      ...
      <div className='px-[5%] pt-6 pb-4'>
        ...
        <h1 className='text-2xl font-bold text-gray-900 dark:text-white mb-2'>{series.title}</h1>

        <p className='text-sm text-gray-600 dark:text-gray-400 mb-4'>{series.description}</p>
        ...
        <div className='flex items-center justify-between text-sm text-gray-600 dark:text-gray-400 mb-4'>
          ...
          <div className='relative'>
            ...
            {showSeriesMenu && (
              <div
                className='absolute top-full right-0 mt-1 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1 min-w-[180px] z-20'
                ref={seriesMenuRef}
              >
                <button
                  onClick={(e) => {
        ...
        <div className='bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700'>
          <div className='flex items-center justify-between text-sm mb-3'>
            <span className='font-bold text-xl text-gray-900 dark:text-white'>{Math.round(progressPercent)}%</span>
      ...
      <div>
        {/* Title */}
        <div className='px-[5%]'>
          <h2 className='text-lg font-bold text-gray-900 dark:text-white mb-3'>エピソード一覧</h2>
        </div>
        ...
        <div className='divide-y divide-gray-200 dark:divide-gray-700 border-t border-gray-200 dark:border-gray-700 mt-4'>
          {sortedEpisodes.map((episode) => {
            ...
            const allChaptersCompleted = hasChapters ? episode.chapters!.every((ch) => ch.isCompleted) : false
            ...
            return (
              <div key={episode.id} className='bg-white dark:bg-gray-900'>
                ...
                <div
                  ...
                  } ${isPlaying ? 'bg-blue-50 dark:bg-blue-900/20' : 'hover:bg-gray-50 dark:hover:bg-gray-800/50'}`}
                >
                  {/* Thumbnail */}
                  <div
                  ...
                  >
                    ...
                    <h4
                      className={`font-semibold truncate mb-1 ${isPlaying ? 'text-blue-800 dark:text-blue-300' : 'text-gray-900 dark:text-white'}`}
                    >
                    ...
                    <div className='flex items-center justify-between gap-2 h-5'>
                      <div className='flex items-center gap-2 text-[10px] font-semibold'>
                        ...
                        {isPlaying && <span className='text-blue-800 dark:text-blue-300 font-bold'>再生中</span>}
                      </div>
                        ...
                        {!hasChapters && (
                          <div className='relative'>
                            ...
                            {showEpisodeMenu === episode.id && (
                              <div
                                className='absolute top-full right-0 mt-1 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1 min-w-[160px] z-20'
                                ref={episodeMenuRef}
                              >
                                <button
                                  onClick={(e) => {
                                ...
                                <button
                                  onClick={(e) => {
                                    e.stopPropagation()
                                    console.log(
                                      episode.isDownloaded ? 'Delete download episode:' : 'Download episode:',
                                      episode.title,
                                    )
                                    setShowEpisodeMenu(null)
                                  }}
                            ...
                            >
                              ...
                              <div className='flex-1 min-w-0 py-2.5 pr-[2px]'>
                                ...
                                <div className='flex items-center gap-1.5 text-[10px] font-semibold text-gray-600 dark:text-gray-400 mt-0.5'>
                                  ...
                                  {isChapterPlaying && <span className='text-blue-700 dark:text-blue-400'>再生中</span>}
                                </div>
                              </div>
                                    ...
                                    >
                                      ...
                                      <button
                                        onClick={(e) => {
                                          e.stopPropagation()
                                          console.log(
                                            chapter.isDownloaded ? 'Delete download chapter:' : 'Download chapter:',
                                            chapter.title,
                                          )
                                          setShowChapterMenu(null)
                                        }}
