...
import { formatDuration, getCategoryLabel, mockPlayHistory } from '@/data/mockData'

import type { DownloadItem } from './DownloadScreen'
            ...
            {downloads.map((download, index) => {
              ...
              return (
                ...
                >
                  ...
                  {deleteMode && (
                    <div className='flex-shrink-0 cursor-pointer' onClick={() => handleToggleSelect(download.id)}>
                      {isSelected ? (
                  ...
                  <div className='flex-1 min-w-0'>
                    ...
                    <p className='text-xs text-gray-600 dark:text-gray-400 truncate mt-0.5'>{download.series.title}</p>
