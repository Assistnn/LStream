import { Heart, Download, PlayCircle, MoreVertical } from 'lucide-react';
import { Series, formatDuration, getCategoryLabel } from '@/data/mockData';
  ...
  if (variant === 'grid') {
    ...
    return (
      ...
      >
        ...
        <h4 className="text-sm font-semibold text-gray-900 dark:text-white line-clamp-2 h-10 mb-1">
          {series.title}
        </h4>
        <div className="h-5 flex items-center justify-between">
          ...
          <div className="relative">
            ...
            {showMenu && (
              <div className="absolute top-full right-0 mt-1 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1 min-w-[160px] z-10" ref={menuRef}>
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    onToggleFavorite?.(series);
