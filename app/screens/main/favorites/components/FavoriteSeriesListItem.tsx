...
import type { FavoriteSeriesItem } from '../../../../repositories/api/IApiRepository'

export const FavoriteSeriesListItem = ({ item, onPress }: { item: FavoriteSeriesItem; onPress?: () => void }) => {
